(function () {
  ...
  var movies = {
    ...
    'Monster (2023)': {
      ...
      trailer:'https://youtu.be/JYIRWnnatBU?si=axyOVZB6jsjMnQgI'
    },
    'Oppenheimer (2023)': {
    ...
    'Avatar: Fire and Ash (2025)': {
      ...
      trailer:'https://youtu.be/nb_fFj_0rq8?si=AUpkts_uzIHsFj2r'
    },
    'Ponyo (2008)': {
    ...
    'Missing (2022)': {
      ...
      trailer:'https://youtu.be/6j0VcUDR9WU?si=F_cF8BIX8AXnRuF8'
    },
    'Chainsaw Man - The Movie: Reze Arc (2025)': {
      ...
      trailer:'https://youtu.be/tAzAhDNdehs?si=tXQvYhE4VpYL-hmH'
    },
    ...
    'Hoppers (2026)': {
      ...
      trailer:'https://youtu.be/PypDSyIRRSs?si=vFiK7TZvI2cf0y2o'
    },
    'Toy Story 4 (2019)': {
    ...
    'The Little Prince (2015)': {
      ...
      trailer:'https://youtu.be/fEPqgSNLfK8?si=cGSIE7OVj8DxEUpf'
    },
    ...
    'Suzume (2022)': {
      ...
      trailer:'https://youtu.be/5pTcio2hTSw?si=BuGabh52Hd12yZgZ'
    }
  };
  ...
  window.addEventListener('DOMContentLoaded', function () {
    ...
    if (clockEl) {
      function updateTime() {
        ...
        clockEl.innerText = 'YOGYAKARTA — ' + timeStr;
      }
